...
//-----------------------------Top panel-------------------------------------
        ...
        label_top.setText("KREDYT"); // wyświetlany tekst
...
//------------------------------Center Panel-----------------------------------
        ...
        JLabel Amo_credit = new JLabel("Podaj kwotę kredytu PLN");
        ...
        JLabel installment= new JLabel("Podaj liczbę rat");
        ...
        JLabel title = new JLabel("Miesięczny dochód PLN");
        ...
        but_calculate.setText("Oblicz wysokość raty");
